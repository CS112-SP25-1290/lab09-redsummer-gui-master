    ...
    public void handleCityButton(ActionEvent e){
        try {
                ...
                if (e.getSource() == cityStateButton2) {
                    ...
                    cityController.initData("Bisbee, AZ", new RevisedHistoricalEvent(HISTORICAL_DATA[1][0], HISTORICAL_DATA[1][1], HISTORICAL_DATA[1][2], new Date(HISTORICAL_DATA[1][3]), HISTORICAL_DATA[1][4], HISTORICAL_DATA[1][5])); 
                } 
               stage.show();
